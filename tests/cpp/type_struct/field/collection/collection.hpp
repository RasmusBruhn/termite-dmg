...
public:
   ...
   * @param field2 
   */
  explicit DataType(int field1, float field2, termite::NodeMap extra_fields) : field1(std::move(field1)), field2(std::move(field2)), extra_fields(std::move(extra_fields)) {}
  ...
  float field2;
  /**
   * @brief All extra fields allocated to this struct
   * 
   */
  termite::NodeMap extra_fields;
};
